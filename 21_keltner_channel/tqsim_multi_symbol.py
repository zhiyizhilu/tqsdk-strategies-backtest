...
def run_backtest(symbol: str, config: dict, tq_account: str, tq_password: str) -> dict:
    from strategy import KeltnerChannelStrategy
    ...
    print(f"EMA周期: {ema_period} | ATR周期: {atr_period} | ATR倍数: {atr_mult}")
...
def main():
    parser = argparse.ArgumentParser(description='肯特纳通道策略多品种回测')
