...
def run_backtest(symbol: str, config: dict, tq_account: str, tq_password: str) -> dict:
    from strategy import ATRStopLossStrategy
    ...
    print(f"MA快: {ma_fast} | MA慢: {ma_slow} | ATR({atr_n})×{atr_multiplier}")
...
def main():
    parser = argparse.ArgumentParser(description='ATR止损策略多品种回测')
