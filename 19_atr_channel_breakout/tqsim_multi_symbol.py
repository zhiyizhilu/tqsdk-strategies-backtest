...
def run_backtest(symbol: str, config: dict, tq_account: str, tq_password: str) -> dict:
    from strategy import ATRChannelBreakoutStrategy
    ...
    print(f"ATR周期: {atr_period} | ATR倍数: {atr_multi} | 中轨周期: {ma_period}")
...
def main():
    parser = argparse.ArgumentParser(description='ATR通道突破策略多品种回测')
