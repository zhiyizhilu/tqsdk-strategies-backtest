...
from strategy import BollingerMeanReversionStrategy
...
def run_single_backtest(symbol: str, tq_account: str, tq_password: str):
    ...
    print(f"BB周期: {bb_period} | 标准差倍数: {bb_std} | RSI周期: {rsi_period}")
