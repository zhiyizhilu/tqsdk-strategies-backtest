...
def run_backtest(symbol: str, config: dict, tq_account: str, tq_password: str) -> dict:
    from strategy import WilliamsRStrategy
    ...
    print(f"%R周期: {wr_period} | 超买线: {overbought_line} | 超卖线: {oversold_line} | MA过滤: {ma_period}")
...
def main():
    parser = argparse.ArgumentParser(description='威廉指标策略多品种回测')
