...
def run_strategy(symbol: str, tq_account: str, tq_password: str):
    ...
    print(f"周期: MA{n_period} | 倍数: {k_times} | 最小带宽: {min_band_width} | K线: {kline_dur//3600}h")
