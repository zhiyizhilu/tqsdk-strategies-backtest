...
def run_backtest(symbol: str, config: dict, tq_account: str, tq_password: str) -> dict:
    ...
    Returns:
        dict: 回测结果字典
    """
    from strategy import AroonTrendStrategy
    ...
    print(f"Aroon周期: {aroon_period} | 阈值: {aroon_thresh}")
...
def main():
    parser = argparse.ArgumentParser(description='Aroon趋势策略多品种回测')
