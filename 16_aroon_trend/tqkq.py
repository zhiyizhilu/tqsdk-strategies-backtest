...
# ===================== 模拟盘配置 =====================
SYMBOL = "KQ.m@SHFE.au"       # 交易合约：连续主力合约（自动换月）
AROON_PERIOD = 25              # Aroon计算周期
AROON_THRESH = 70              # Aroon强势阈值
KLINE_DUR = 5 * 60             # K线周期：300秒 = 5分钟K线
...
def run_strategy(symbol: str, tq_account: str, tq_password: str):
    ...
    print(f"Aroon周期: {aroon_period} | 阈值: {aroon_thresh} | K线: {kline_dur//60}min")
