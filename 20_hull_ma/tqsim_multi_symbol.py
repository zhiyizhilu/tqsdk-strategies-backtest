...
def run_backtest(symbol: str, config: dict, tq_account: str, tq_password: str) -> dict:
    from strategy import HullMAStrategy
    ...
    hma_period = config.get("hma_period", 20)
...
def main():
    parser = argparse.ArgumentParser(description='Hull MA策略多品种回测')
