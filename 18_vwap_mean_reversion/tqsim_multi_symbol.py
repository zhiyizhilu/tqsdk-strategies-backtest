...
def run_backtest(symbol: str, config: dict, tq_account: str, tq_password: str) -> dict:
    from strategy import VWAPMeanReversionStrategy
    ...
    print(f"VWAP周期: {vwap_period} | 偏离阈值: {deviation}%")
...
def main():
    parser = argparse.ArgumentParser(description='VWAP均值回归策略多品种回测')
