...
from strategy import IchimokuCloudStrategy
...
def run_single_backtest(symbol: str, tq_account: str, tq_password: str):
    ...
    print(f"转换线: {tenkan_period} | 基准线: {kijun_period} | 先行线: {senkou_period}")
    print(f"信号模式: 状态驱动（转换线/基准线位置 + 价格/云图位置）")
